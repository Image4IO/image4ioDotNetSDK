...
{
    public class APIUnitTestFixture : IDisposable
    {
    ...
    public class APIUnitTest : IClassFixture<APIUnitTestFixture>
    {
        readonly APIUnitTestFixture fixture;

        public APIUnitTest(APIUnitTestFixture _fixture)
        {
